...
public class GraphAdjList extends Graph {
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 ...
		 List<Integer> twoHopVertices = new ArrayList<Integer>();
		 
		 for (int neighboringVertex : getNeighbors(v))
			 twoHopVertices.addAll(getNeighbors(neighboringVertex));
		 
		 return twoHopVertices;
	}
