...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		for(int vertex=0; vertex < numVertices; vertex++) {
			degreeSequence.add(getNeighbors(vertex).size()
					+ getInNeighbors(vertex).size());
		}
	...
	public static void main (String[] args) {
		...
		System.out.println("distance-two verices: " + graphFromFile.getDistance2(0));
		System.out.println("distance-two verices: " + graphFromFile.getDistance2(1));
		System.out.println("distance-two verices: " + graphFromFile.getDistance2(2));
