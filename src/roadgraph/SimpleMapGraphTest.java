...
public class SimpleMapGraphTest {

	static void simpleTest() {
		GeographicPoint 	testStart = new GeographicPoint(1.0, 1.0);
		GeographicPoint testEnd = new GeographicPoint(8.0, -1.0);
		MapGraph testMap = new SimpleMapGraph();
		...
		testAStarSearch(testStart, testEnd, testMap);	
	}
	...
	static void testAStarSearch(GeographicPoint start, GeographicPoint end, MapGraph map) {
		long startTime;
		long endTime;
		List<GeographicPoint> testroute;

		startTime = System.nanoTime();
		testroute = map.aStarSearch(start,end);
		endTime = System.nanoTime();
		System.out.println("\tTime taken - " + (endTime-startTime)/1000 + "us");
		System.out.println("\tPath - " + testroute);		
	}
