...
public abstract class MapGraph {
	 ...
	 *   path from start to goal (including both start and goal).
	 */
	protected abstract List<GeographicPoint> bfs(GeographicPoint start,
	 ...
	 *   start to goal (including both start and goal).
	 */
	protected abstract List<GeographicPoint> dijkstra(GeographicPoint start,
			GeographicPoint goal, Consumer<GeographicPoint> nodeSearched);
	 ...
	 *   start to goal (including both start and goal).
	 */
	protected abstract List<GeographicPoint> aStarSearch(GeographicPoint start,
			GeographicPoint goal, Consumer<GeographicPoint> nodeSearched);
