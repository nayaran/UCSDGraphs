...
public class DataSet {
	String filePath;
	roadgraph.CachedMapGraph graph;
    ...
    public void initializeGraph() {
        graph = new roadgraph.CachedMapGraph();
