...
public class DataSet {
	String filePath;
	roadgraph.SimpleMapGraph graph;
    ...
    public void initializeGraph() {
        graph = new roadgraph.SimpleMapGraph();
